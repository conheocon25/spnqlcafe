...
class User extends Object{
	...
	function isAdmin(){if ($this->getType()==1)return true;return false;}	
	function isManager(){if ($this->getType()==2)return true;return false;}	
	function isBoss(){if ($this->getType()==3)return true;return false;}	
	...
	function getStoreAll(){
		...
		$SU 		= $mStoreUser->findByUser(array($this->getId()));
		return $SU;
	}
