<?php 
function tpl_521d79d3_SettingTermPaid__qnNFxTArUgSrme_27G3tCA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 28 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->TermPaid = new PHPTAL_RepeatController($ctx->TermPaidAll)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->TermPaid as $ctx->TermPaid): ;
?>
<tr>
										<?php /* tag "td" from line 29 */; ?>
<td width="32">
											<?php /* tag "div" from line 30 */; ?>
<div><?php echo phptal_escape($ctx->path($ctx->repeat, 'TermPaid/number')); ?>
</div>
										</td>										
...
<td>
											<?php 
/* tag "a" from line 33 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->TermPaid, 'getURLUpdLoad')))):  ;
...
<span><?php echo phptal_escape($ctx->path($ctx->TermPaid, 'getName')); ?>
</span>
											</a>
										</td>
...
<td width="32">
											<?php 
/* tag "a" from line 38 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->TermPaid, 'getURLDelLoad')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<a class="btn" href="/setting/termpaid/ins/load">
...
Generated by PHPTAL from I:\quanly-cafe\demo1\mvc\templates\SettingTermPaid.html (edit that file instead) */; ?>