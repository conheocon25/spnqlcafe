<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<span class="label pull-right copyright">&#169; 2012 SPN</span>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="badge badge-info pull-right"><?php echo phptal_escape($ctx->path($ctx->ConfigAll, 'count')); ?>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="icon-coffee" style="color:red;"></i>
					</span>
					Demo Cafe SPN
				</a>
...
<span><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/theme/bootstrap/js/bootstrap.min.js"></script>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/bootstrap/css/madmin.css"/>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="icon" type="image/png" href="/data/images/icon.png"/>
 ...
 ?>
<?php 
function tpl_522181d9_mAdmin__dlx0IIFQsnXP6mkXUBJwLw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
