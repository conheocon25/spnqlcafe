...
class OrderImportDetail extends Mapper implements \MVC\Domain\OrderImportDetailFinder {
    ...
    function __construct() {
		...
		$tblResource = "cafedemo2_resource";
		$tblOrderImport = "cafedemo2_order_import";
		$tblOrderImportDetail = "cafedemo2_order_import_detail";
		$tblSessionDetail = "cafedemo2_session_detail";
		$tblR2C = "cafedemo2_r2c";
		...
		$trackByExportStmt = sprintf("
			...
			from
				cafedemo2_session S inner join cafedemo2_session_detail SD on S.id = SD.idsession
			where
				SD.idcourse IN(select id_course from cafedemo2_r2c where id_resource=?) AND
