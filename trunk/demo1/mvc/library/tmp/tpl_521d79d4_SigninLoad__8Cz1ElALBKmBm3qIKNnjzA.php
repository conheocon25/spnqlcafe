<?php 
function tpl_521d79d4_SigninLoad__8Cz1ElALBKmBm3qIKNnjzA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<label class="control-label" for="SigninEmailLabel">Email</label>
								<?php /* tag "div" from line 18 */; ?>
<div class="controls">
									<?php /* tag "input" from line 19 */; ?>
<input type="text" id="SigninEmail" name="Email"/>
								</div>
							</div>
							<?php /* tag "div" from line 22 */; ?>
<div class="control-group">
								<?php /* tag "label" from line 23 */; ?>
<label class="control-label" for="SigninPassLabel">Mật khẩu</label>
								<?php /* tag "div" from line 24 */; ?>
<div class="controls">
									<?php /* tag "input" from line 25 */; ?>
<input type="Password" id="SigninPass" name="Pass"/>
								</div>
							</div>																								
...
Generated by PHPTAL from I:\quanly-cafe\demo1\mvc\templates\SigninLoad.html (edit that file instead) */; ?>