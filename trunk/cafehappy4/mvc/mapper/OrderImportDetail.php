...
class OrderImportDetail extends Mapper implements \MVC\Domain\OrderImportDetailFinder {
    ...
    function __construct() {
		...
		$tblResource = "cafehappy4_resource";
		$tblOrderImport = "cafehappy4_order_import";
		$tblOrderImportDetail = "cafehappy4_order_import_detail";
		$tblSessionDetail = "cafehappy4_session_detail";
		$tblR2C = "cafehappy4_r2c";
		...
		$trackByExportStmt = sprintf("
			...
			from
				cafehappy4_session S inner join cafehappy4_session_detail SD on S.id = SD.idsession
			where
				SD.idcourse IN(select id_course from cafehappy4_r2c where id_resource=?) AND
